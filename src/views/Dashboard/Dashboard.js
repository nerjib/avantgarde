...
useEffect(()=>{
  axios.get(`https://kdpall.herokuapp.com/api/v1/punits/apc`)
  .then(res=>{
     // alert(res.data[0].sum)
      setApc(res.data[0].sum)
  }).catch(e=>{console.log(e)})
  axios.get(`https://kdpall.herokuapp.com/api/v1/punits/pdp`)
  .then(res=>{
    //  alert(res.data)
      setPdp(res.data[0].sum)
  }).catch(e=>{console.log(e)})
  axios.get(`https://kdpall.herokuapp.com/api/v1/punits/others`)
  .then(res=>{
    //  alert(res.data)
      setOthers(res.data[0].sum)
  }).catch(e=>{console.log(e)})
  axios.get(`https://kdpall.herokuapp.com/api/v1/punits/accredited`)
  .then(res=>{
    //  alert(res.data)
      setAccredited(res.data[0].sum)
  }).catch(e=>{console.log(e)})

  axios.get(`https://kdpall.herokuapp.com/api/v1/punits/wards/ABADAWA`)
  .then(res=>{
    //  alert(res.data)
      setAbadawa(res.data[0])
  }).catch(e=>{console.log(e)})

  axios.get(`https://kdpall.herokuapp.com/api/v1/punits/wards/DAN ALHAJI`)
  .then(res=>{
    //  alert(res.data)
      setDanalhaji(res.data[0])
  }).catch(e=>{console.log(e)})
  axios.get(`https://kdpall.herokuapp.com/api/v1/punits/wards/GARU`)
  .then(res=>{
    //  alert(res.data)
      //setAbadawa(res.data[0])
      setGaru(res.data[0])
  }).catch(e=>{console.log(e)})
  axios.get(`https://kdpall.herokuapp.com/api/v1/punits/wards/GURE`)
  .then(res=>{
    //  alert(res.data)
      //setAbadawa(res.data[0])
      setGure(res.data[0])
  }).catch(e=>{console.log(e)})
  axios.get(`https://kdpall.herokuapp.com/api/v1/punits/wards/KAYARDA`)
  .then(res=>{
    //  alert(res.data)
      //setAbadawa(res.data[0])
      setKayarda(res.data[0])
  }).catch(e=>{console.log(e)})
  axios.get(`https://kdpall.herokuapp.com/api/v1/punits/wards/LAZURU`)
  .then(res=>{
    //  alert(res.data)
      //setAbadawa(res.data[0])
      setLazuru(res.data[0])
  }).catch(e=>{console.log(e)})
  axios.get(`https://kdpall.herokuapp.com/api/v1/punits/wards/LERE`)
  .then(res=>{
    //  alert(res.data)
      //setAbadawa(res.data[0])
      setLere(res.data[0])
  }).catch(e=>{console.log(e)})
  axios.get(`https://kdpall.herokuapp.com/api/v1/punits/wards/RAMIN KURA`)
  .then(res=>{
    //  alert(res.data)
      //setAbadawa(res.data[0])
      setRaminkura(res.data[0])
  }).catch(e=>{console.log(e)})
  axios.get(`https://kdpall.herokuapp.com/api/v1/punits/wards/SABON BIRNI`)
  .then(res=>{
    //  alert(res.data)
      //setAbadawa(res.data[0])
      setSabonbirni(res.data[0])
  }).catch(e=>{console.log(e)})
  axios.get(`https://kdpall.herokuapp.com/api/v1/punits/wards/SAMINAKA`)
  .then(res=>{
    //  alert(res.data)
      //setAbadawa(res.data[0])
      setSaminaka(res.data[0])
  }).catch(e=>{console.log(e)})
  axios.get(`https://kdpall.herokuapp.com/api/v1/punits/wards/YAR KASUWA`)
  .then(res=>{
    //  alert(res.data)
      //setAbadawa(res.data[0])
  ...
  axios.get(`https://kdpall.herokuapp.com/api/v1/results/cunits`)
  .then(res=>{
    //  alert(res.data)
      //setAbadawa(res.data[0])
      setCunits(res.data)
  }).catch(e=>{console.log(e)})
  axios.get(`https://kdpall.herokuapp.com/api/v1/results/aggcunits`)
  .then(res=>{
    //  alert(res.data)
      //setAbadawa(res.data[0])
