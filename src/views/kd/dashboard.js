...
export default function KDDashboard() {
  ...
  let [selectedLga, setSelectedLGA]= useState('IKARA')
  ...
  let [type, setType]=useState('GOVERNORSHIP')
...
useEffect(()=>{
    axios.get(`https://kdpall.herokuapp.com/api/v1/kdpunits/getlga`)
    .then(res=>{
       // alert(res.data[0].sum)
        setLgaList(res.data)
    }).catch(e=>{console.log(e)})

    axios.get(`https://kdpall.herokuapp.com/api/v1/kdpunits/lga/${selectedLga}/${type}`)
    .then(res=>{
       // alert(res.data[0].sum)
        setLgaResult(res.data[0])
    }).catch(e=>{console.log(e)})

    axios.get(`https://kdpall.herokuapp.com/api/v1/kdpunits/getward/${selectedLga}`)
    .then(res=>{
       // alert(res.data[0].sum)
        setLgaWard(res.data)
    }).catch(e=>{console.log(e)})

    axios.get(`https://kdpall.herokuapp.com/api/v1/kdpunits/lgabyward/${selectedLga}/${type}`)
    .then(res=>{
       // alert(res.data[0].sum)
        setLgaWardAgg(res.data)
    }).catch(e=>{console.log(e)})
    axios.get(`https://kdpall.herokuapp.com/api/v1/kdpunits/allpu/${selectedLga}`)
    .then(res=>{
       // alert(res.data[0].sum)
        setAllLgPuNo(res.data[0])
    }).catch(e=>{console.log(e)})
    axios.get(`https://kdpall.herokuapp.com/api/v1/kdpunits/votedpu/${selectedLga}/${type}`)
    .then(res=>{
       // alert(res.data[0].sum)
...
let Electiontype = ["PRESIDENTIAL","SENATORIAL","HOUSE OF REPRESENTATIVE","GOVERNORSHIP","STATE ASSEMBLY", "CHAIRMANSHIP", "COUNCILLORSHIP"]
